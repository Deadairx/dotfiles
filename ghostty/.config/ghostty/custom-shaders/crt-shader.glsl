...
const float GLOBAL_OPACITY = 0.3;        // Overall transparency (1.0 = fully opaque, 0.0 = fully transparent)
...
const float BRIGHT_BOOST = 1.3;          // Brightness multiplier for bright pixels (default: 1.2)
...
const float SCANLINE_DENSITY = 0.36;     // Density/thickness of scanlines (default: 0.25)

// Dot Matrix Settings
const float MASK_INTENSITY = 0.3;          // Strength of the dot pattern (default: 0.3)
